...
module.exports = {
	name: 'olx',
	description: 'Caută ce vrea inima ta pe olx.',
	category: 'Misc',
	cooldown: 5000,
	async execute(message, args, client) {
		const search_embed = new embed(message, "OLX Search");
        ...
        let response = await google.search(args.join(' ') + " site:https://www.olx.ro/", {
            page: 0,
            safe: true
        }).catch(() => {
